            ...
            <div class="col-12">
                <div class="card m-b-30">
                    <div class="card-header">
                        <h4 class="mt-0 header-title">Laporan Data Peminjaman</h4>
                    </div>
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <a href="<?= site_url('peminjaman/cetakpdf') ?>" target="_blank" class="btn btn-danger">
                        ...
                        <div id="viewdata">
                            <div class="table-responsive">
                                <table class="table table-sm table-striped" id="datapeminjaman">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th>No Faktur</th>
...
<script>
    $(document).ready(function() {
        ...
        let dataTable = $('#datapeminjaman').DataTable({
            "language": {
                "search": "Cari:",
        ...
        $('#btnFilter').click(function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if ($.fn.DataTable.isDataTable('#datapeminjaman')) {
                        $('#datapeminjaman').DataTable().destroy();
                    }

                    $('#datapeminjaman tbody').empty();
                    ...
                    $('#datapeminjaman tbody').html(html);
        ...
        $('.btn-danger').click(function(e) {
            ...
            let url = "<?= site_url('Peminjam/cetakpdf') ?>";
            if (tanggal_awal && tanggal_akhir) {
