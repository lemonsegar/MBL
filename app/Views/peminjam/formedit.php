            ...
            <form action="/Peminjam/update" method="post">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="idpel" id="idpel" placeholder="ID Pelanggan" class="form-control" value="<?= $peminjam['idpel'] ?>" readonly>
                            <input type="text" id="nama" placeholder="Nama Pelanggan" class="form-control" value="<?= $peminjam['nama'] ?>" readonly>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="idmobil" id="idm" placeholder="ID Mobil" class="form-control" value="<?= $peminjam['idmobil'] ?>" readonly>
                            <input type="text" id="noplat" placeholder="No Plat" class="form-control" value="<?= $peminjam['noplat'] ?>" readonly>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <label for="hrgsewa" class="form-label">Harga Sewa</label>
                        <input type="text" id="hrgsewa" class="form-control" value="<?= $peminjam['hrgsewa'] ?>" readonly>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-3">
                        ...
                        <input type="number" class="form-control" name="lama" id="lama" value="<?= $peminjam['lama'] ?>" placeholder="Lama Penyewaan" required>
                    </div>
                    <div class="col-md-3">
                        <label for="hrgsewa" class="form-label">Tanggal Kembali</label>
                        <input type="date" class="form-control" name="tglkembali" id="tglkembali" value="<?= $peminjam['tanggalkembali'] ?>" placeholder="Tanggal Kembali" required readonly>
                    </div>
                    <div class="col-md-6">
                        <label for="total" class="form-label">Total Bayar</label>
                        <input type="number" class="form-control" name="total" id="total" value="<?= $peminjam['total'] ?>" placeholder="Total Bayar" required>
                    </div>
                </div>
